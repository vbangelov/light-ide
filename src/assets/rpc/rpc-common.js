...
export class RpcCommon {
  ...
  handleResponse(message) {
    console.trace(
      `handleResponse: processing response for id: ${message.id} method: ${message.method} message success flag is: ${message.success}`,
    );
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (method) {
        ...
        try {
          ...
          console.error(`handleRequest: Failed processing request id: ${message.id}`, { error: err });
